...
export default function Home() {
  ...
  const { city, setCity, getBrowserLocation } = useLocation();
      ...
      <div className="section-container space-y-16">
        ...
        >
          <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-700">
            ...
            <h1
              id="hero-heading"
              className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-secondary leading-[1.1] tracking-tight"
            >
              {t.tagline}
            </h1>
            <p className="text-lg md:text-xl text-medical-text-light leading-relaxed max-w-xl">
              DocNearby connects you directly with independent doctors and local
              clinics. Transparent healthcare without the corporate middleman.
            </p>
            ...
            <nav className="pt-6" aria-labelledby="specialties-heading">
              <p
                ...
                className="text-xs font-bold text-medical-text-light uppercase tracking-widest mb-4"
              >
          ...
          <div
            className="relative animate-in fade-in slide-in-from-right-4 duration-700"
            aria-hidden="true"
          >
            <div className="medical-card p-2">
              ...
              <div className="absolute -left-6 top-1/4 medical-card !rounded-2xl p-4 flex items-center gap-4 animate-bounce-slow">
                ...
                <div>
                  <p className="text-xs font-bold text-medical-text-light">
                    Doctors Verified
                  </p>
        ...
        {/* Search & Location Bar */}
        <section
          className="medical-card p-6 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700"
          aria-label="Location and search filters"
        >
          <div className="grid lg:grid-cols-[1fr_auto] gap-6 items-end">
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="city-input" className="medical-label">
                  {t.city || "Search City"}
                </label>
                <div className="relative">
                  <span
                    className="absolute left-4 top-1/2 -translate-y-1/2 text-medical-text-light"
                    aria-hidden="true"
                  >
                    <svg
                      className="w-5 h-5"
                  ...
                  />
                  <span id="city-help" className="sr-only">
                    Enter the city name to find doctors nearby
                  </span>
                </div>
              </div>
              <div className="space-y-2">
        ...
        <section
          className="grid lg:grid-cols-[1fr_1.5fr] gap-8 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200"
        ...
        >
          ...
          <div className="medical-card p-8 space-y-6">
            <div className="space-y-2">
              <label htmlFor="symptoms-input" className="sr-only">
            ...
            {suggestions.length > 0 && (
              <div
                className="pt-8 border-t border-slate-100 animate-in zoom-in-95 duration-500"
                aria-live="polite"
              >
